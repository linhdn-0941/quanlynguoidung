...
class Migration
{
    ...
    {
        try {
            $connect = new PDO('mysql:host=localhost', Migration::USERNAME, Migration::PASSWORD);
            $connect->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

            $createDataBase = 'CREATE DATABASE IF NOT EXISTS ' . Migration::DATABASE_NAME;
            $use = 'use ' . Migration::DATABASE_NAME;
            ...
            $dropDatabase = 'DROP DATABASE IF EXISTS ' . Migration::DATABASE_NAME;
